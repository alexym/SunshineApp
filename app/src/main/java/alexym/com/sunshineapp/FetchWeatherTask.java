...
public class FetchWeatherTask extends AsyncTask<String, Void, Void> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        long currentId = 0;
        Cursor ticketsCursor = cresolver.query(
        ...
        if(ticketsCursor.moveToFirst()){
            currentId = ticketsCursor.getLong(ticketsCursor.getColumnIndex(WeatherContract.LocationEntry._ID));
        }else{
            ...
            Uri currentUri = cresolver.insert(WeatherContract.LocationEntry.CONTENT_URI,cv);
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                inserted  = cresolver.bulkInsert(WeatherEntry.CONTENT_URI,cvArray);
            }
    ...
    protected Void doInBackground(String... params) {
        ...
        String format = "json";
        String units = "metric";
        String apiKey = "195c18cbd1e2ae91ffe5a9bda70d042d";
        int numDays = 14;
